...
const S = {
  ...
  confirmBox:    { backgroundColor: '#fff', borderRadius: '12px', width: 'min(400px, calc(100vw - 32px))', maxWidth: '100%', padding: '28px 28px 24px', boxShadow: '0 8px 40px rgba(0,0,0,0.18)' },
