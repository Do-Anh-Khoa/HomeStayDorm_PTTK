...
const S = {
  ...
  confirmBox:     { backgroundColor: '#fff', borderRadius: '12px', width: 'min(380px, calc(100vw - 32px))', maxWidth: '100%', padding: '28px 28px 24px', boxShadow: '0 8px 40px rgba(0,0,0,0.18)' },
  ...
  // toast
  toast:          { position: 'fixed', top: '90px', right: '24px', maxWidth: 'calc(100vw - 48px)', overflowWrap: 'anywhere', padding: '12px 20px', borderRadius: '10px', fontSize: '14px', fontWeight: 600, zIndex: 2000, boxShadow: '0 4px 20px rgba(0,0,0,0.15)' },
