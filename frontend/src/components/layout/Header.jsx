...
export default function Header({ role }) {
  return (
    <header className="flex h-20 min-w-0 shrink-0 items-center justify-end overflow-x-hidden border-b border-[#d8ddc8] bg-[#fffefb] px-4 sm:px-6 xl:px-8">
      <div className="flex min-w-0 items-center justify-end gap-3 sm:gap-4">
        <p className="hidden min-w-0 text-right text-sm font-bold leading-tight text-[#1e2618] sm:block">
